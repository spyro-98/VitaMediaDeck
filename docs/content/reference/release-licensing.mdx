---
title: Release and licensing
description: GPL-3.0-only distribution, release contents, security gates, and the hardware player module plan.
icon: Scale
---
...
- Credential synchronization, cloud accounts, or a hosted VitaMediaDeck
  service.
...
and related marks belong to their respective owners. No affiliation or
