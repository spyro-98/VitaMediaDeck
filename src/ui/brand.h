#ifndef VITAMEDIADECK_UI_BRAND_H
#define VITAMEDIADECK_UI_BRAND_H

#include <stddef.h>

/* VitaMediaDeck header shared by search, results, and the IME keyboard. */
...
#endif /* VITAMEDIADECK_UI_BRAND_H */
