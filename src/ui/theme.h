...
#define VT_THEME_SURFACE        RGBA8(6, 15, 17, 246)
#define VT_THEME_SURFACE_RAISED RGBA8(10, 25, 28, 250)
#define VT_THEME_SURFACE_FOCUS  RGBA8(23, 34, 34, 248)
#define VT_THEME_BORDER         RGBA8(59, 78, 77, 255)
#define VT_THEME_BORDER_DIM     RGBA8(24, 39, 40, 255)
#define VT_THEME_GLASS_A(a)     RGBA8(10, 31, 35, (a))

/* Amber is projected data and human focus, not a large decorative fill. */
#define VT_THEME_SIGNAL_DIM     RGBA8(111, 59, 25, 255)
#define VT_THEME_SIGNAL         RGBA8(198, 101, 31, 255)
#define VT_THEME_SIGNAL_BRIGHT  RGBA8(235, 148, 57, 255)
#define VT_THEME_SIGNAL_LIGHT   RGBA8(255, 207, 126, 255)
#define VT_THEME_SIGNAL_A(a)    RGBA8(226, 128, 41, (a))
...
#define VT_THEME_COLD_DIM       RGBA8(29, 77, 84, 255)
#define VT_THEME_COLD           RGBA8(55, 137, 146, 255)
#define VT_THEME_COLD_LIGHT     RGBA8(151, 208, 209, 255)
#define VT_THEME_COLD_A(a)      RGBA8(71, 159, 166, (a))
