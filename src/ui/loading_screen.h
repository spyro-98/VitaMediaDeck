#ifndef VITAMEDIADECK_UI_LOADING_SCREEN_H
#define VITAMEDIADECK_UI_LOADING_SCREEN_H
...
/* Primitive shared with the grid: VitaMediaDeck orbital indicator. Must be
...
#endif /* VITAMEDIADECK_UI_LOADING_SCREEN_H */
