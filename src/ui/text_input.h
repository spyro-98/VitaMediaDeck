#ifndef VITAMEDIADECK_UI_TEXT_INPUT_H
#define VITAMEDIADECK_UI_TEXT_INPUT_H
 ...
 * view: VitaMediaDeck keeps drawing its own header and shows the live text in
...
#endif /* VITAMEDIADECK_UI_TEXT_INPUT_H */
