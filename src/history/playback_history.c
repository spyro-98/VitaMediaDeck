...
#define VT_PLAYBACK_HISTORY_PATH VITAMEDIADECK_DATA_DIR "/playback_history.bin"
#define VT_PLAYBACK_HISTORY_TEMP VITAMEDIADECK_DATA_DIR "/playback_history.tmp"
#define VT_PLAYBACK_HISTORY_BACKUP VITAMEDIADECK_DATA_DIR "/playback_history.bak"
