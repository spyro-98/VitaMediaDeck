...
#define VT_SUBTITLE_BORDER_CYAN     4
#define VT_SUBTITLE_BORDER_ORANGE   5
#define VT_SUBTITLE_BORDER_BLUE     6
#define VT_SUBTITLE_BORDER_GRAY     7
...
#define VT_SUBTITLE_TEXT_ORANGE 4
#define VT_SUBTITLE_TEXT_MAGENTA 5
#define VT_SUBTITLE_TEXT_BLUE   6
#define VT_SUBTITLE_TEXT_GRAY   7

#define VT_SUBTITLE_SIZE_SMALL  0
#define VT_SUBTITLE_SIZE_MEDIUM 1
#define VT_SUBTITLE_SIZE_LARGE  2
#define VT_SUBTITLE_SIZE_EXTRA_LARGE 3
...
#define VT_SUBTITLE_POSITION_TOP    3

#define VT_SUBTITLE_FONT_INTER_MEDIUM   0
#define VT_SUBTITLE_FONT_INTER_SEMIBOLD 1
#define VT_SUBTITLE_FONT_VITA_SYSTEM    2
#define VT_SUBTITLE_FONT_VITA_JAPANESE  3
#define VT_SUBTITLE_FONT_VITA_CHINESE   4
#define VT_SUBTITLE_FONT_VITA_KOREAN    5
#define VT_SUBTITLE_FONT_VITA_LATIN     6
...
#define VT_SUBTITLE_BACKGROUND_NAVY        4
#define VT_SUBTITLE_BACKGROUND_BURGUNDY    5
#define VT_SUBTITLE_BACKGROUND_FOREST      6
#define VT_SUBTITLE_BACKGROUND_SMOKE       7
