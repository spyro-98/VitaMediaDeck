...
The files are kept close to upstream so early-startup and crash diagnostics can render without depending on the full VitaTube UI stack. VitaTube-specific logging lives in the adjacent `text_log` implementation.
