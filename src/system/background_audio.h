#ifndef VITATUBE_SYSTEM_BACKGROUND_AUDIO_H
#define VITATUBE_SYSTEM_BACKGROUND_AUDIO_H
 ...
 * when VitaTube isn't the foreground app. sceAppMgrAcquireBgmPort() is the
...
#endif /* VITATUBE_SYSTEM_BACKGROUND_AUDIO_H */
