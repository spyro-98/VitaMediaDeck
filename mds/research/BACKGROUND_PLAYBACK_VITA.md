...
VitaTube acquires the AppMgr lease before opening the BGM port and releases the
...
music widget. Undocumented shell symbols are outside VitaTube's production
scope.
...
- Stop playback and close VitaTube while decoding is active.
