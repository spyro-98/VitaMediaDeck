...
VitaMediaDeck offers either an exact application profile or zero clock writes so PSVshell remains fully authoritative. Debug data should report read-back values rather than assuming a requested clock was applied.
